...
in question. */
SELECT 'expensive' AS cost, name, monthlymaintenance
FROM `Facilities`
WHERE monthlymaintenance >100

SELECT 'cheap' AS cost, name, monthlymaintenance
FROM `Facilities`
WHERE monthlymaintenance <100
...
LIMIT 1
/* Still need to select the first row from this without LIMIT!!!*/
